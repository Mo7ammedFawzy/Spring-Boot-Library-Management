...
const lightTheme = themeQuartz.withParams({
  ...
  borderWidth: 1,
  wrapperBorder: false,
  headerRowBorder: { color: '#e1e4e8', width: 1, style: 'solid' },
  rowBorder: { color: '#e1e4e8', width: 1, style: 'solid' },
  columnBorder: false,
...
const darkTheme = themeQuartz.withParams({
  ...
  headerFontSize: 11,
  headerFontWeight: 600,
  headerTextColor: '#9eaebf',
  headerBackgroundColor: '#1a2433',
  backgroundColor: '#1a2433',
  textColor: '#e1e7ee',
  subtleTextColor: '#7d8d9f',
  borderColor: '#2e3e53',
  borderWidth: 1,
  wrapperBorder: false,
  headerRowBorder: { color: '#2e3e53', width: 1, style: 'solid' },
  rowBorder: { color: '#2e3e53', width: 1, style: 'solid' },
  columnBorder: false,
  rowHoverColor: '#25374c',
  rowHeight: props.rowHeight,
  headerHeight: props.headerHeight,
  paginationPanelHeight: 48,
  spacing: 8,
